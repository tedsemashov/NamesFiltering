...
class Names extends Component {
   ...
   render() {
      return (
           <div>
              <Pagination
                   activities={[{id: '1', name: 'something'}, {id: '2', name: 'something'}, {id: '3', name: 'something'},
                      {id: '4', name: 'something'}, {id: '5', name: 'something'}, {id: '6', name: 'something'}, {
                         id: '7',
                         name: 'something'
                      },
                      {id: '8', name: 'something'}, {id: '9', name: 'something'}, {id: '10', name: 'something'}, {
                         id: '11',
                         name: 'something'
                      },
                      {id: '12', name: 'something'}, {id: '13', name: 'something'}, {id: '14', name: 'something'}, {
                         id: '15',
                         name: 'something'
                      },
                      ...
                      {id: '46', name: 'something'}, {id: '47', name: 'something'},
                       ...
                       {id: '40', name: 'something'}, {id: '41', name: 'something'}, {id: '42', name: 'something'},
                       {id: '43', name: 'something'}, {id: '44', name: 'something'}, {id: '45', name: 'something'},
                       {id: '46', name: 'something'}, {id: '47', name: 'something'},                      {id: '43', name: 'something'}, {id: '44', name: 'something'}, {id: '45', name: 'something'},
                       {id: '46', name: 'something'}, {id: '47', name: 'something'},
                       {id: '40', name: 'something'}, {id: '41', name: 'something'}, {id: '42', name: 'something'},
                       {id: '43', name: 'something'}, {id: '44', name: 'something'}, {id: '45', name: 'something'},
                       {id: '46', name: 'something'}, {id: '47', name: 'something'},
